...
{
    public class GenericsRefactorTwo<T> where T : IComparable
    {
        public T First_value ,Second_value ,Third_value;
        public GenericsRefactorTwo(T First_value , T Second_value ,T Third_value)
        {
        ...
        public static T FindMax (T First_value , T Second_value ,T Third_value)
        {
            ...
            else if(Second_value.CompareTo(Third_value)>0 && Second_value.CompareTo(First_value)>0)
            {
        ...
        {
            T result = FindMax(First_value,Second_value ,Third_value);
